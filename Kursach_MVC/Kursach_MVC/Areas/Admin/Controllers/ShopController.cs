    ...
    public class ShopController : Controller
    {
        ...
        public ActionResult AddProduct()
        {
            ...
            using (Db db = new Db())
            {
                ...
                model.Restaraunts = new SelectList(db.Restaurants.ToList(), "id", "Name");
            }
        ...
        public ActionResult AddProduct(ProductVM model, HttpPostedFileBase file)
        {
            ...
            using (Db db = new Db())
            {
                ...
                product.RestarauntId = model.RestarauntId;

                CategoryDTO catDTO = db.Categories.FirstOrDefault(x => x.Id == model.CategoryId);
                RestaurantDTO restDTO = db.Restaurants.FirstOrDefault(x => x.Id == model.RestarauntId);
                product.CategoryName = catDTO.Name;
                product.RestarauntName = restDTO.Name;
            ...
            TempData["SM"] = "Вы изменили страницу блюда!";
