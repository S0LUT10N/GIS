    ...
    public class CartController : Controller
    {
            ...
            using (Db db = new Db())
            {
                ...
                if (productInCart == null)
                {
                    cart.Add(new CartVM()
                    {
                        ...
                        RestaurantId = product.RestarauntId,
                        RestaurantName = product.RestarauntName,                       
                        Quantity = 1,
                        Price = product.Price,
        ...
        public void PlaceOrder()
        {
            ...
            using (Db db = new Db())
            {
                ...
                orderDto.RestaurantId = cart.FirstOrDefault().RestaurantId;
                ...
                foreach (var item in cart)
                {
                    ...
                    orderDetailsDto.ProductName = item.ProductName;
                    orderDetailsDto.Price = item.Price;
                    orderDetailsDto.RestaurantId = item.RestaurantId;
                    orderDetailsDto.RestaurantName = item.RestaurantName;
